...
<form method="POST" enctype="multipart/form-data" action="{{ route('posts.store') }}"
    ...
    x-data="{ imagePreview: '', showRemoveButton: false, content: '' }">
    ...
    <div>
        ...
        <div class="flex items-center justify-between">
                ...
                <div>
                    ...
                    <label for="image"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            class="w-6 h-6 text-sky-800" stroke="currentColor">
            ...
            <div>
                <!-- Post Button -->
                <button type="submit"
                    class="-m-2 flex gap-2 text-xs items-center rounded-full px-4 py-2 font-semibold bg-sky-600 hover:bg-black text-white">
                    Post
                </button>
                <!-- /Post Button -->
            </div>
